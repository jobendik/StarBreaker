...
export const ICONS: Record<string, string> = {
  ...
  sentry: `<svg viewBox="0 0 24 24" fill="none" stroke="${S}" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M6 18h12M9 18l1.2-5.5M15 18l-1.2-5.5"/><rect x="7" y="7" width="10" height="6" rx="1.5"/><path d="M12 7V4M9 4h6M17 10h4M3 10h4"/></svg>`,
  ...
  plasma: `<svg viewBox="0 0 24 24" fill="none" stroke="${S}" stroke-width="1.7" stroke-linecap="round"><circle cx="12" cy="12" r="3"/><path d="M12 2.5a9.5 9.5 0 010 19M12 2.5a9.5 9.5 0 000 19"/><path d="M4.2 8.5c4 2 11.6 2 15.6 0M4.2 15.5c4-2 11.6-2 15.6 0" opacity=".65"/></svg>`,
  drone: `<svg viewBox="0 0 24 24" fill="none" stroke="${S}" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5l5 4v6l-5 4-5-4V9z"/><circle cx="12" cy="12" r="2"/><path d="M4 7l3 2M20 7l-3 2M4 17l3-2M20 17l-3-2"/></svg>`,
  snare: `<svg viewBox="0 0 24 24" fill="none" stroke="${S}" stroke-width="1.7" stroke-linecap="round"><circle cx="12" cy="12" r="8"/><path d="M12 4c4 5-5 4-1 10 2 3 6 1 6-2M7 13c3-2 4 2 8-1"/><path d="M12 1.8v3M12 19.2v3M1.8 12h3M19.2 12h3"/></svg>`,
  squadron: `<svg viewBox="0 0 24 24" fill="none" stroke="${S}" stroke-width="1.7" stroke-linejoin="round"><path d="M12 2l5 13-5-3-5 3z"/><path d="M5 8l3 9-3-2-3 2zM19 8l3 9-3-2-3 2z" opacity=".75"/></svg>`,
